	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'jumtechWP' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'jumtechWP' ); ?></th>
			</tr>
		</thead>
		<tbody>
